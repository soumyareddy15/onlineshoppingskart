...
export class ProductUploadComponent implements OnInit {
  ...
  OnSubmit(Retailerid,Productname,Productquantity,Productprice,Productdescription,Productbrand,Categoryid,Image){
   ...
   this.imageService.UploadImage(Retailerid.value,Productname.value,Productquantity.value,Productprice.value,Productdescription.value,Productbrand.value,Categoryid.value,Image).subscribe(
     data =>{
       console.log('done');
